...
namespace Bookstore.Controllers
{
    public class StoreController : Controller
    {
        ...
        public ActionResult Books()
        {
            ...
            {
                new BookModel {BookId = 1,Name = "UX Design",Author = "Cabbage",Image = "https://encrypted-tbn0.gstatic.com/images?q=tbn:ANd9GcQEcbvZUQNVbxQJv9SeZVQ79MOd6ucMSUeMUg&usqp=CAU",Rating = "4.5",Reviews = 22,OriginalPrice = 2000,DiscountPrice = 1200},
